...
class Letter(TimeStampedModel):
    # Main letter fields matching frontend
    ...
    # Receiver information (keeping as separate fields to match frontend structure)
...
class LetterItem(TimeStampedModel):
    ...
    name = models.CharField(max_length=500)  # Changed from item_name to name
    ...
    def __str__(self):
        return f"{self.serial_number}. {self.item_name}"
