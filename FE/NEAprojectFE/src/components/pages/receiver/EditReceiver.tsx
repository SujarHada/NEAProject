...
import type { createReceiverInputs, Receiver } from "app/interfaces/interfaces";
	...
	return (
		<div className="flex flex-col gap-6">
			...
			<div className="flex gap-4 w-full flex-wrap">
				<div className="lg:w-1/2 flex flex-1 flex-col gap-2 ">
					<label htmlFor="office_name">
						{" "}
						{t("editReceiver.labels.deptName")}{" "}
					</label>
					<Controller
						name="office_name"
						control={control}
					...
					/>
					{errors.office_name && (
						<p className="text-red-500">{errors.office_name.message}</p>
					)}
				</div>
				<div className="lg:w-1/2 flex flex-1 flex-col gap-2 ">
					<label htmlFor="office_address">
						{" "}
						{t("editReceiver.labels.deptAddress")}{" "}
					</label>
					<Controller
						name="office_address"
						control={control}
					...
					{errors.office_address && (
						<p className="text-red-500">{errors.office_address.message}</p>
					)}
				</div>
			</div>
			<div className="flex gap-4 w-full flex-wrap">
				...
				<div className="lg:w-1/2 flex flex-1 flex-col gap-2 ">
					<label htmlFor="vehicle_number">
						{" "}
						{t("editReceiver.labels.vehicleNo")}{" "}
					</label>
					<Controller
						name="vehicle_number"
						control={control}
			...
			<div className="flex">
				...
				>
					{isSubmitting
						? t("editReceiver.labels.creating")
						: t("editReceiver.labels.createReceiver")}
				</button>
			</div>
		</div>
	);
