...
const CreateLetter = () => {
	...
	}, [StoreMethods.getLetterCreationData, StoreMethods.getReceivers, StoreMethods.getOffices, StoreMethods.getProducts]);
		...
		<div className="flex flex-col gap-3">
			...
			<div className="flex flex-1 flex-row gap-2 flex-wrap">
				...
				<div className="flex max-sm:w-full flex-col">
					...
					/>
					{errors.date && (
						<span className="text-[#B22222]">{errors.date.message}</span>
					)}
				</div>
				...
				<div className="flex flex-1 w-full flex-col">
					...
					/>
					{errors.chalani_no && (
						<span className="text-[#B22222]">{errors.chalani_no.message}</span>
					)}
				</div>
				...
				<div className="flex flex-1 w-full flex-col">
					...
					/>
					{errors.voucher_no && (
						<span className="text-[#B22222]">{errors.voucher_no.message}</span>
					)}
				</div>
				...
				<div className="flex max-md:flex-1 max-md:w-full flex-col">
					...
					/>
					{errors.gatepass_no && (
						<span className="text-[#B22222]">{errors.gatepass_no.message}</span>
					)}
				</div>
			</div>
			...
			<div className="flex flex-col flex-wrap gap-4">
				<div className="flex flex-row flex-1 gap-2 w-full flex-wrap">
					<div className="flex flex-col w-full flex-1 ">
						...
						{errors.office_id && (
							<span className="text-[#B22222]">{errors.office_id.message}</span>
						)}
					</div>
					...
					<div className="flex w-full flex-col flex-1">
						...
						/>
						{errors.subject && (
							<span className="text-[#B22222]">{errors.subject.message}</span>
						)}
					</div>
				</div>
