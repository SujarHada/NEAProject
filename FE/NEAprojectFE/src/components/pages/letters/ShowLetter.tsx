...
const ShowLetter = () => {
	...
	const ContentSection = () => (
		<div className="content">
			उपरोक्त सम्बन्धमा तहाँको प.सं. {letter?.letter_count} च.नं. {letter?.chalani_no}{" "}
			मिति {letter?.request_date} को माग पत्रानुसार तपसिलमा उल्लेखित विद्युतीय जिन्सी
			सामानहरु निम्न उल्लेखित कर्मचारी/व्यक्ति हस्ते पठाइएको छ। उक्त सामानहरुको ट्रान्सफर नोट
				...
				{paginatedItems.map((chunk, pageIndex) => (
					...
					>
						...
						<footer className="page-number">
							पाना {engToNep(`${paginatedItems.length}`)} मध्ये{" "}
							{engToNep(`${pageIndex + 1}`)}
						</footer>
					</div>
				))}
			</div>
