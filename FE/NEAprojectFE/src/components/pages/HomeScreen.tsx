...
export default function HomeScreen() {
	...
	const cards = [
		...
		},
		{
			...
			icon: <Building2 />,
			value: stats.total_active_branches,
		},
		{
			title: t("dashboard.active_offices"),
			icon: <Building2 />,
			value: stats.total_active_offices,
		},
		{
		...
		{
			title: t("dashboard.total_receivers"),
			icon: <Inbox />,
