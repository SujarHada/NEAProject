...
const Profile = () => {
	...
	const [activeTab, setActiveTab] = useState<"password" | "createUser">(
		"password",
	);
	...
	return (
		<div className="relative h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0b132b] via-[#1c2541] to-[#3a506b] text-gray-100 overflow-hidden p-4 sm:p-10">
			...
			{/* 🧑‍💼 Main Card */}
			<div
				className="w-full relative h-full max-w-xl overflow-auto sm:max-w-2xl bg-white/10 border border-white/20 rounded-2xl sm:rounded-3xl shadow-2xl sm:p-10 text-center"
				...
				<div className="mt-4 sm:mt-4">
					{activeTab === "password" && (
						...
						>
							...
							<button
								type="submit"
								className="w-full mt-3 sm:mt-4 bg-blue-600 hover:bg-blue-700 transition text-white font-semibold py-2 rounded-md"
							>
