		...
		<div className="flex flex-col gap-6">
			...
			<div className="flex flex-col lg:w-1/2 gap-2">
				<label htmlFor="organization_id">
					{t("createEmployee.labels.branchId")} *
				</label>
				<Controller
			...
			<div className="flex w-full flex-wrap gap-4">
				<div className="flex flex-1 flex-col gap-2">
					<label htmlFor="first_name">
						{t("createEmployee.labels.firstName")} *
					</label>
					<Controller
						name="first_name"
						control={control}
				...
				<div className="w-full flex-1 flex flex-col gap-2">
					<label htmlFor="middle_name">
						{t("createEmployee.labels.middleName")}
					</label>
					<Controller
						name="middle_name"
						control={control}
				...
				<div className="w-full flex flex-1 flex-col gap-2">
					<label htmlFor="last_name">
						{t("createEmployee.labels.lastName")} *
					</label>
					<Controller
						name="last_name"
						control={control}
					...
					render={({ field }) => (
						...
						>
							<option value="" disabled hidden>
								{t("createEmployee.placeholders.position")}
							</option>
			...
			<div className="flex">
				...
				>
					{isSubmitting
						? t("createEmployee.button.creating")
						: t("createEmployee.button.create")}
				</button>
			</div>
		</div>
	);
