	...
	return (
		<div className="flex flex-1 flex-col gap-6 ">
						...
						render={({ field }) => (
							<div className=" w-full ">
								<select
									id="unit"
									{...field}
									className="bg-[#B5C9DC] w-full appearance-none border-2 h-10 outline-none px-3 rounded-md border-gray-600"
								>
									<option value="" disabled hidden>
										{t("editProductPage.unit")}
									</option>
			...
			<div className="flex">
				...
				>
					{isSubmitting
						? t("editProductPage.savingButton")
						: t("editProductPage.submitButton")}
				</button>
			</div>
		</div>
	);
