...
export const createEmployeesFormSchema = (t: (key: string) => string) => {
	return z.object({
		...
		email: z
			.email(t("createEmployee.errors.emailInvalid"))
...
export interface CreateEmployeesFormData
	extends z.infer<ReturnType<typeof createEmployeesFormSchema>> {}
...
export const updateEmployeesFormSchema = (t: (key: string) => string) => {
	return z
		.object({
			...
			email: z
				.email(t("editEmployee.errors.emailInvalid"))
				.min(1, t("editEmployee.errors.emailRequired")),
...
export interface UpdateEmployeesFormData
	extends z.infer<ReturnType<typeof updateEmployeesFormSchema>> {}
